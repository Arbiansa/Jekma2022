...
<body>
    ...
    <div class="container">
        <div class="card" style="width: 26rem;">
            <img src="../asset/img/helmet.png" class="card-img-top" alt="..." style="background-color: #FF5E60;">
            <?php
            ...
            endwhile;
            ?>
            <form action="../controller/proses_gojek.php" method="post">
                <div class="input-group mb-3">
                    <input type="hidden" name="id_cust" value="<?php echo $id_cust; ?>">
                    <input type="hidden" name="id_driver" value="<?php echo $id_driver; ?>">
                    <input class="card-booking" type="text" class="form-control" aria-label="nama-driver" aria-describedby="basic-addon1" value="<?php echo $nama_driver; ?>">
                </div>
                <div class="input-group mb-3">
                    <input class="card-booking" type="text" class="form-control" aria-label="nama-driver" aria-describedby="basic-addon1" value="<?php echo $nama_cust; ?>">
                </div>
                <div class="input-group mb-3">
                    <input class="card-booking" type="text" class="form-control" aria-label="nama-driver" aria-describedby="basic-addon1" value="<?php echo $no_cust; ?>">
                </div>
                <div>
                ...
                <div class="row">
                    <div class="col-6 py-3">
                        <a href="rating_ojek.php"><button name='online' class="button-bayar btn bg-success">BAYAR ONLINE</button></a>
                    </div>
                    <div class="col-6 py-3">
                        <a href="rating_ojek.php"><button name='offline' class="button-bayar btn bg-danger">KIRIM PESAN</button></a>
                    </div>
                </div>
            </form>
        </div>
    ...
    <img src="../asset/img/map.png" alt="" class="position-absolute end-0 top-0 map-img">
    </div>
    </div>
