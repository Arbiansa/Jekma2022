        ...
        <div class="row">
            <div class="card col-3">
                ...
                <div>
                    ...
                    $query = mysqli_query($conn, "SELECT nim_driver, nama_driver,no_driver, nama_cust, no_cust, nama_makanan, CONCAT(awal,' - ', akhir) AS jalur, SUM(harga_makanan + harga_jalur) AS Total FROM transaksi INNER JOIN driver USING(id_driver) INNER JOIN customer USING(id_cust) INNER JOIN makanan USING(id_makanan) INNER JOIN jalur USING(id_jalur) WHERE id_transaksi='$id_transaksi';");
                    ...
                    ?>
                        ...
                        <div>
                            <p class="p"><?php echo $data['nama_makanan'] ?></p>
                        </div>
                        <div>
                        ...
                        <div>
                            <a href="whatsapp://send?text=Nama Pemesan %20: <?php echo $data['nama_cust']; ?>%0APesanan %20: <?php echo $data['nama_makanan']; ?>%0ALokasi %20: <?php echo $data['jalur']; ?> %0ATotal %20: <?php echo $data['Total']; ?>&phone=<?php echo $data['no_driver']; ?>"> <button class="btn bg-success" style="color: white; margin-left: 70px;">HUBUNGI DRIVER</button> </a>
                        </div>
                    <?php endwhile; ?>
                </div>
